...
const Contact = () => {
  ...
  const validatePhoneNumber = () => {
    if (formData.phone) {
      const phoneRegex = /^[0-9]{10}$/; // Validate 10-digit phone numbers
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://my-portfolio-f933-db94fb9pb-shuklshaiuedus-projects.vercel.app/send-email', {
        method: 'POST',
        body: formDataToSend,
      });
        ...
        <Row>
          ...
          <Col lg={6}>
            <div className="contact-info p-4 rounded shadow h-100" style={{ backgroundColor: 'white',color: '#333' }}>
              ...
              <div className="map-container mt-4 rounded overflow-hidden" style={{ height: '300px' }}>
                <iframe 
